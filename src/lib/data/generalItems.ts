...
export const generalItems: Item[] = [
    ...
    { id: "cardamom_clarity_potion", name: "Cardamom Clarity Potion", description: "A warm, spiced brew that temporarily heightens elemental attack.", image: "/general/cardamom_clarity_potion.png", type: "general", flags: ["stackable", "special"], activeEffects: [{ id: "clarity_critChance_buff", name: "Spiced Clarity", stat: "critChance", value: .25, duration: 100, type: "flat", source: "cardamom_clarity_potion" },{ id: "cardamom_critDamage_buff", name: "Spiced Clarity", stat: "critDamage", value: .50, duration: 100, type: "flat", source: "cardamom_clarity_potion" } ], instanceId: "" },
