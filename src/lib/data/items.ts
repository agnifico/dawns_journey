...
const otherItems: Item[] = [
    ...
    },
    {
        ...
        type: "relic",
        stats: [{ name: "agility", value: 10 }, { name: "maxHp", value: 100 }],
        element: "Earth",
        flags: ['special'],
    },
    {
    ...
    },
    {
        ...
        type: "relic",
        stats: [{ name: "resilience", value: 10 }, { name: "physicalDefence", value: 10 }],
        element: "Dark",
        flags: ['special'],
    },
    {
    ...
    },
    {
        ...
        type: "relic",
        stats: [{ name: "elementalDefence", value: 6 }, { name: "resilience", value: 6 }],
        element: "Light",
        flags: ['special'],
    },
    {
        ...
        type: "relic",
        stats: [{ name: "elementalAttack", value: 5 }, { name: "perception", value: 5 }],
        element: "Dark",
        flags: ['special'],
    },
    {
        ...
        type: "relic",
        stats: [{ name: "physicalDefence", value: 150 }, { name: "resilience", value: 20 }],
        element: "Fire",
        flags: ['special'],
    },
    {
    ...
    },
    {
        ...
        type: "relic",
        stats: [{ name: "auraShield", value: 20 }, { name: "resilience", value: 15 }],
        element: "Dark",
        flags: ['special'],
    },
    {
        ...
        type: "relic",
        stats: [{ name: "elementalDefence", value: 7 }, { name: "resilience", value: 7 }],
        element: "Light",
        flags: ['special'],
    },
    {
        id: "seabed_fossil",
        name: "Seabed Fossil",
        description: "A fossilized fragment from the deepest trenches of the ocean, it grants the wearer the resilience of the deep sea and a connection to ancient aquatic magic.",
        image: "/relics/seabed_fossil.png",
        type: "relic",
        stats: [{ name: "elementalDefence", value: 150 }, { name: "perception", value: 30 }],
        element: "Water",
        flags: ['special'],
    },
...
export const items: Item[] = [...otherItems, ...homesteadItems];
