...
const arenaNpcs: Record<string, Combatant> = {
    ...
    veres: {
        ...veresTemplate,
        baseStats: { ...withAccuracy(veresTemplate.baseStats), 
            hp: 1000, maxHp: 1000,
            maxAuraShield: 300, auraShield: 300,
            physicalAttack: 400, elementalAttack: 100,
            physicalDefence: 100, elementalDefence: 100,
            evasion: 120, precision: 120, speed: 120,
            critChance: 0.6, critDamage: 1.8,
        },
        arenaBehavior: {
            phases: [
