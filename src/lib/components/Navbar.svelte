...
<nav class="navbar">
    ...
    <button class="hamburger mobile-only" on:click={toggleMenu} aria-label="Toggle menu" aria-expanded={menuOpen}>
...
<div class="mobile-menu mobile-only" class:open={menuOpen}>
    ...
    <div class="mobile-menu-section">
        ...
        <div class="mobile-icon-grid">
            <button class="icon-button" on:click={() => { SaveLoadService.saveGame(); menuOpen = false; }} title="Save Game">
                <img src="/game_icons/save.png" alt="Save" />
                <span>Save</span>
            </button>
            <button class="icon-button" on:click={() => { SaveLoadService.loadGame(); menuOpen = false; }} title="Load Game">
                <img src="/game_icons/load.png" alt="Load" />
                <span>Load</span>
            </button>
