...
<div class="notification-container">
	{#each $notificationStore as notification (notification.id)}
		{#if notification.type === 'item_equipped' || notification.type === 'item_received' || notification.type === 'item_used' || notification.type === 'item_removed' || notification.type === 'item_unequipped'}
			<div
