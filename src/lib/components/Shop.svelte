<script lang="ts">
    ...
    import { getAllItems, addItems, countInventoryItem, removeItemsByItemId } from '$lib/services/InventoryService';
    ...
    function buyItem(item: Item) {
        ...
        playerStore.update(player => {
            ...
            messageStore.addMessage(`Bought ${item.name} for ${item.price} Argentum.`, ['System', 'World']);
            return newPlayer;
        });
    }
</script>
