<script lang="ts">
    ...
    function canCraft(recipe: CraftingRecipe): boolean {
        return recipe.ingredients.every(ing => hasItem($playerStore.inventory, ing.itemId, ing.quantity));
    }
</script>
        ...
        {#each recipes as recipe}
            <div class="recipe" class:can-craft={canCraft(recipe)}>
                <div class="recipe-header">
                    <img src={recipe.image || itemDictionary[recipe.output.itemId].image} alt={recipe.name} class="recipe-image"/>
                ...
                <div class="ingredients">
                    ...
                    <ul>
                        {#each recipe.ingredients as ingredient}
                            <li>
                                <img src={itemDictionary[ingredient.itemId].image} alt={itemDictionary[ingredient.itemId].name} class="ingredient-image"/>
